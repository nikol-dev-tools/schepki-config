...
| # | Расширение | Точное название в сторе | Статус | Store URL | Примечания |
|---|---|---|---|---|---|
| 1 | **Pomodoro Timer** | Pomodoro Timer | 🟡 In Review | Ожидается после аппрува | GA4 ✅ Remote Config ✅ |
| 2 | **Breathing Timer** | Breathing Timer — Calm & Focus | 🟡 In Review | Ожидается после аппрува | GA4 ✅ Remote Config ✅ |
